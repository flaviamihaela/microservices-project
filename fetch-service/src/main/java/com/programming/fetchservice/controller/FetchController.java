...
// Marks class as controller where methods return domain object
@RestController
...
public class FetchController {
    ...
    // Sets a time limit for call
    @TimeLimiter(name="inventory")
    // Specifies method should be retried in case of failure
    @Retry(name = "inventory")
    public CompletableFuture<String> placeFetch(@RequestBody @Valid FetchRequest fetchRequest) {
    ...
    @GetMapping
    //Marks method with HTTP status code
